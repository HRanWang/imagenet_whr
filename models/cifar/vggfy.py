...
class VGG16(nn.Module):  # TODO: try different config of the channels
    ...
    def forward(self, input_x):
        ...
        # x_layer1 = nn.functional.avg_pool2d(x_layer1, kernel_size=(16, 16), stride=(1, 1))
        ...
        x_layer2 = nn.functional.avg_pool2d(x_layer2, kernel_size=(8, 8), stride=(1, 1))
        ...
        x_layer3 = nn.functional.avg_pool2d(x_layer3, kernel_size=(4, 4), stride=(1, 1))
        ...
        #     x_shuff[:, :] = x[:, perm]
        #
        return self.fc(x),x_layer2,x_layer3#,x_layer2#,x_layer3
